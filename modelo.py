...
datos =extract_data("LVI1.txt", False) # toma todos los datos como un array
...
for i in range(t.shape[0]):
    if i>=987:   # el uno es la posicion de mi salto 
        h1[i]=1
...
fig, axs = pl.subplots(3)
fig.suptitle('Estación LVI1',fontsize=14)
...
axs[0].plot(datos['data'][:,0], datos['data'][:,1],color="blue", linewidth=2, linestyle="dotted",label='Datos') 
...
# en axs[0] ploteamos primera columna de datos con la fecha que son los años
axs[1].plot(datos['data'][:,0], datos['data'][:,2],color="blue", linewidth=2, linestyle="dotted")
...
axs[2].plot(datos['data'][:,0], datos['data'][:,3],color="blue", linewidth=2, linestyle="dotted")
...
fig.suptitle('Estación LVI1')

axs[0,0].plot(datos['data'][:,0], datos['data'][:,1],color="lightgreen", linewidth=2, linestyle="dotted",label='Datos') 
...
# en axs[0] ploteamos primera columna de datos con la fecha que son los años
axs[1,0].plot(datos['data'][:,0], datos['data'][:,2],color="lightgreen", linewidth=2, linestyle="dotted")
...
axs[2,0].plot(datos['data'][:,0], datos['data'][:,3],color="lightgreen", linewidth=1, linestyle="dotted")
...
#Columna 2
axs[0,1].plot(datos['data'][:,0], res_ew,color="k", linewidth=1, linestyle="dotted",label='Residuales') 
...
# en axs[0] ploteamos primera columna de datos con la fecha que son los años
axs[1,1].plot(datos['data'][:,0], res_ns,color="k", linewidth=1, linestyle="dotted")
...
axs[2,1].plot(datos['data'][:,0], res_up,color="k", linewidth=1, linestyle="dotted")
